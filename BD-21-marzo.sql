...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2015 a las 16:48:21
-- Versión del servidor: 5.6.21
-- Versión de PHP: 5.6.3

--
-- se modificó la fk de prestamo y la pk de videojuegos para que sea serial.
--
...
--
-- Creación: 13-03-2015 a las 08:32:45
--
...
--
-- Creación: 21-03-2015 a las 15:22:54
--
...
(1, 'Batman', 'Videojuego de accion', 6000, 'PS4', 11, 'Covers\\\\batman_ps4.jpg', 'L63rDlpJ3_o', 1),
(2, 'Crysis', 'videojuego de ciencia ficcion', 4000, 'PC', 17, 'Covers\\\\crysis_pc.jpg', 'IFz2evkDvxk', 2),
(3, 'Assassins Creed 2', 'videojuego de ciencia ficcion', 7500, 'X-BOX_360', 19, 'Covers\\\\assassinscreed2_360.jpg', 'LGC88YwrfkM', 1),
(4, 'Call of Duty: Black Ops 2', 'Video juego de guerra', 6500, 'X-Box_360', 19, 'Covers\\\\callofdutybo2_360.jpg', 'kqOjoYRgnHs', 10),
...
(8, 'Final Fantasy XIII', 'Video Juego de Fantasia y aventura', 12000, 'X-Box_360', 19, 'Covers\\\\finalfantasy13_360.jpg', 'iponuRPeEgs', 4),
...
--
ALTER TABLE `prestamo`
MODIFY `id_prestamo` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT de la tabla `videogame`
--
ALTER TABLE `videogame`
MODIFY `id_vj` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
