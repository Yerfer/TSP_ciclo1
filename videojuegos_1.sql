...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2015 a las 18:45:06
...
(1, 'Batman', 'Videojuego de accion', 6000, 'PS4', 19, 'Covers\\\\batman_ps4.jpg', 'L63rDlpJ3_o', 1),
(2, 'Crysis', 'videojuego de ciencia ficcion', 4000, 'PC', 19, 'Covers\\\\crysis_pc.jpg', 'IFz2evkDvxk', 2),
(3, 'Assassins Creed 2', 'videojuego de ciencia ficcion', 7500, 'X-BOX_360', 20, 'Covers\\\\assassinscreed2_360.jpg', 'LGC88YwrfkM', 1),
...
(6, 'Fallout 3', 'Video juego de ciencia ficcion', 8000, 'PC', 20, 'Covers\\\\fallout3_pc.jpg', 'FUhCzMZO1Vk', 2),
...
(13, 'NFS: Rivals', 'Video Juego carreras', 12000, 'PS4', 20, 'Covers\\\\needforspeedrivals_ps4.jpg', 'NoTu4Zx3Lhg', 9),
(14, 'Call of Duty: Ghosts', 'Video Juego de guerra', 11000, 'PS4', 20, 'Covers\\\\callofdutyghost_ps4.png', 'FAcvGByZNHs', 10),
(15, 'El Chavo', 'Video Juego de misiones y aventuras', 6000, 'WII', 20, 'Covers\\\\elchavo_wii.png', 'mduzkFawrdI', 4),
(16, 'God of War 2', 'Video Juego misiones y combates', 7000, 'PC', 19, 'Covers\\\\godofwar2_pc.png', 'exzXh-RRheU', 6);
...
--
ALTER TABLE `prestamo`
MODIFY `id_prestamo` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
